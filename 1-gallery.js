...
`,a=i.map(s).join("");console.log(a);const l=document.createElement("ul");l.classList.add("gallery");l.insertAdjacentHTML("beforeend",a);const t=document.querySelector(".container h1");t.after(l);new r(".gallery a",{captionsData:"alt",captionDelay:250});

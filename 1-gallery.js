...
`,s=r.map(i).join(""),l=document.createElement("ul");l.classList.add("gallery");l.insertAdjacentHTML("beforeend",s);const t=document.querySelector(".container h1");t.after(l);new m(".gallery a",{captionsData:"alt",captionDelay:250});
